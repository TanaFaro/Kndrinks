  ...
  try {
    ...
    // Mapeo de nombres de archivos a información del producto
        ...
        const imageMapping: Record<string, any> = {
          ...
          'Sprite.webp': { category: 'Bebidas', price: 3400, description: 'Refresco sabor lima-limón', type: 'product' },
          'prittyde3lts.webp': { category: 'Bebidas', price: 3000, description: 'Gaseosa sabor limón 3 litros', type: 'product' },
          'SpeedXL.webp': { category: 'Bebidas', price: 2800, description: 'Bebida energética XL', type: 'product' },
          'DURenaissance.jfif': { category: 'Licores', price: 5000, description: 'Vodka premium francés', type: 'product' },
          ...
          'cocadescartable.jpg': { category: 'Bebidas', price: 4200, description: 'Coca Cola en botella descartable', type: 'product' },
